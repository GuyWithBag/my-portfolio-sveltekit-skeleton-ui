...
export declare function createDataTableStore<T extends Record<PropertyKey, any>>(source: T[], options?: DataTableOptions<T>): {
    subscribe: (this: void, run: import("svelte/store").Subscriber<DataTableModel<T>>, invalidate?: import("svelte/store").Invalidator<DataTableModel<T>> | undefined) => import("svelte/store").Unsubscriber;
